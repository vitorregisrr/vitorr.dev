...
description: A codificação do HTML e CSS é uma uma das práticas mais presentes na vida de um desenvolvedor Front-end, 
date: '2019-05-24 02:58'
image: /assets/img/bracos-robo.png
category: html
background: '#D6BA32'
---

![Aperto de mãos entre homem e máquina.](/assets/img/bracos-robo.png)
...
![GIF Ilustrando o uso de exclamação(!) para gerar um documento HTML](https://cdn-images-1.medium.com/max/2000/1*siAYVmlRgb8DCj1aeyt4Nw.gif)*GIF Ilustrando o uso de exclamação(!) para gerar um documento HTML*
...
![Print Screen da documentação do site oficial EMMET](https://cdn-images-1.medium.com/max/3770/1*TDfcXw0upvwhde3Cw5N0Pg.png)*Print Screen da documentação do site oficial EMMET*
...
![GIF ilustrando o uso da abreviação -trf](https://cdn-images-1.medium.com/max/2000/1*YEuoyTm5TA3ySEE2InKQTw.gif)*GIF ilustrando o uso da abreviação -trf*
...
![GIF ilustrando o uso do atalho “Refletir Valor CSS”](https://cdn-images-1.medium.com/max/2000/1*TcsmBfV1P54QWFWrQqYe4g.gif)*GIF ilustrando o uso do atalho “Refletir Valor CSS”*
...
![GIF Ilustrando oS atalhos (Ctrl + D) e (Shift + Ctrl + D)](https://cdn-images-1.medium.com/max/2000/1*qnYszX4iV7iyBXnPv0hcCw.gif)*GIF Ilustrando oS atalhos (Ctrl + D) e (Shift + Ctrl + D)*

* **Remove Tag/(Ctrl + K)**: Remove uma tag.

![GIF Ilustrando o atalho (Ctrl + K)](https://cdn-images-1.medium.com/max/2000/1*w40mieVAlIViHFOQu-_5ww.gif)*GIF Ilustrando o atalho (Ctrl + K)*

* **Merge Lines/(Shift + Ctrl + M)**: Une as linhas selecionadas.

![GIF Ilustrando o atalho (Shift + Ctrl + M)](https://cdn-images-1.medium.com/max/2000/1*mEJIa3TPtxY5YWxn1OiQzQ.gif)*GIF Ilustrando o atalho (Shift + Ctrl + M)*

* **Toggle Comment/(Ctrl + /): **Comenta uma linha.

![GIF Ilustrando o atalho (Shift + /)](https://cdn-images-1.medium.com/max/2000/1*UFrXepY-8HFV9l6GeNpyDA.gif)*GIF Ilustrando o atalho (Shift + /)*

* **Evaluate Math Expression/(Shift + Ctrl + Y): **Resolve uma expressão matemática.

![GIF Ilustrando o atalho (Shift + Ctrl + Y)](https://cdn-images-1.medium.com/max/2000/1*sHzVWTVL4ASxJRF4OuoO0A.gif)*GIF Ilustrando o atalho (Shift + Ctrl + Y)*
